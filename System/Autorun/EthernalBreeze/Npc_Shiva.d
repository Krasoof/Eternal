...
{
	AI_Output(other, self, "DIA_StExt_StonedTrader_hi_01");			// ��� ����, ��������?
...
{
	AI_Output(other, self, "DIA_StExt_StonedTrader_AndrielReady_01");		// ��� � ���� ������ ����?
	AI_Output(self, other, "DIA_StExt_Wisp_15_00");							// ...
	b_giveplayerxp(100);
...
{
	AI_Output(other, self, "DIA_StExt_StonedTrader_AndrielDone_01");		// � ���������� � ��������!
	AI_Output(self, other, "DIA_StExt_Wisp_15_00");							// (���������� ����������) ...
...
{
	AI_Output(other, self, "DIA_StExt_StonedTrader_MephistoDone_01");		// ������� ��������!
	AI_Output(self, other, "DIA_StExt_Wisp_15_00");							// ...
...
{
	AI_Output(other, self, "DIA_StExt_StonedTrader_DiabloDone_01");			// � ��������� ������!
	AI_Output(self, other, "DIA_StExt_Wisp_15_00");							// ...
...
{
	AI_Output(other, self, "DIA_StExt_StonedTrader_BaalDone_01");			// ����...
	AI_Output(self, other, "DIA_StExt_StonedTrader_BaalDone_02");			// ���, � ����! � ������� ���� �� ���� �������������� ������, �����.
...
instance dia_none_99666_StonedTrader_EnchantArmor(c_info)
{
    npc = none_99666_StonedTrader;
    nr = 9;
    condition = dia_none_99666_StonedTrader_EnchantArmor_condition;
    information = dia_none_99666_StonedTrader_EnchantArmor_info;
    permanent = true;
